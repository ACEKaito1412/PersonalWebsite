<div class="d-flex flex-column w-100 h-auto justify-content-center">
    ...
    <div class="d-flex flex-column flex-lg-row m-4  neu-inset">
        <div class="overflow-hidden p-3 d-flex align-items-center justify-content-center" style="width: 400px; aspect-ratio: 1/1;">
            <img src="<?= site_url() . 'public/uploads/' . $project['img_src'] ?>" alt="..." style="width: 200px">
        </div>
        <div class="d-flex justify-content-center flex-column p-3 w-100 w-lg-50">
            ...
            <a href="<?= site_url('/projects/' . $project['id']) ?>" class="btn neu neu-btn p-color">Go somewhere</a>
        </div>
    </div>
</div>